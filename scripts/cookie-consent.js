...
function CookieConsent(props) {
  ...
  function renderModal() {
    ...
    self.modalContent = self.modalContent.replace(
      /--header--/,
    ...
    self.modalContent = self.modalContent.replace(
      /--footer--/,
      "<div class='buttons'>" +
        "<button class='btn-accept-necessary " +
        self.props.buttonSecondaryClass +
        "'>" +
        _t.buttonAcceptTechnical +
        "</button>" +
        "<button class='btn-accept-all " +
        self.props.buttonPrimaryClass +
        "'>" +
        _t.buttonAcceptAll +
        "</button>" +
        "</div>",
    ...
    if (
      getCookie(self.props.cookieName) === undefined &&
      self.props.autoShowModal
    ) {
      showDialog();
    }
  }
    ...
    request.onloadend = function () {
      if (request.status === 404 && lang !== self.props.defaultLang) {
        console.warn(
          "language " +
            lang +
            " not found trying defaultLang " +
            self.props.defaultLang,
        );
